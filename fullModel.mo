...
model fullModel
  OM_SP7.Socket.ConnectionObjects.SocketConnection con = OM_SP7.Socket.ConnectionObjects.SocketConnection();
  Modelica.Blocks.Interfaces.RealOutput y;
  Modelica.Blocks.Interfaces.RealOutput a1 = 0;
  Modelica.Blocks.Interfaces.RealOutput a2 = 0;
  Modelica.Blocks.Interfaces.RealOutput a3 = 0;
  Modelica.Blocks.Interfaces.RealOutput a4 = 0;
  Modelica.Blocks.Interfaces.RealOutput a5 = 0;
  Modelica.Blocks.Interfaces.RealOutput a6 = 0;
  Modelica.Blocks.Interfaces.RealOutput a7 = 0;
...
//    Placement(visible = true, transformation(extent = {{-152, -86}, {-132, -66}}, rotation = 0)));
  ...
  Utils.terminateSimulationOnKey terminateSimulationOnKey annotation(
    Placement(visible = true, transformation(origin = {-44, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  y = OM_SP7.Socket.Functions.getJointPositions(con,time);
...
//    Line(points = {{-37, 72}, {-37, 72.5}, {-20, 72.5}, {-20, 29}}, color = {0, 0, 127}));
  connect(a1, sixPositionAxis.joint4SetPosition) annotation(
    Line(points = {{-131, 18}, {-104, 18}, {-104, 4}, {-49, 4}}, color = {0, 0, 127}));
  connect(a3, sixPositionAxis.joint3SetPosition) annotation(
    Line(points = {{-131, -14}, {-106, -14}, {-106, -4}, {-49, -4}}, color = {0, 0, 127}));
  connect(a2, sixPositionAxis.joint2SetPosition) annotation(
    Line(points = {{-131, -46}, {-100, -46}, {-100, -11}, {-49, -11}}, color = {0, 0, 127}));
  connect(a5, sixPositionAxis.joint5SetPosition) annotation(
    Line(points = {{-131, 48}, {-100, 48}, {-100, 13}, {-49, 13}}, color = {0, 0, 127}));
  connect(a6, sixPositionAxis.joint6SetPosition) annotation(
    Line(points = {{-131, 80}, {-94, 80}, {-94, 20}, {-49, 20}}, color = {0, 0, 127}));
  connect(a1, sixPositionAxis.joint1SetPosition) annotation(
    Line(points = {{-131, -76}, {-94, -76}, {-94, -19}, {-49, -19}}, color = {0, 0, 127}));
  connect(a7, sixPositionAxis.joint7SetPosition) annotation(
    Line(points = {{-37, 72}, {-37, 72.5}, {-20, 72.5}, {-20, 29}}, color = {0, 0, 127}));
