...
model sixPositionAxis_newPid
  ...
  OM_SP7.Axis.FDL_DCPositionAxis fDL_DCPositionAxis1(Td = 1, Ti = 0.9, controllerType = Modelica.Blocks.Types.SimpleController.PI, pidGain = 500, wd = 10, wp = 1)  annotation(
    Placement(visible = true, transformation(origin = {10, 56}, extent = {{-14, -10}, {14, 10}}, rotation = 0)));
  OM_SP7.Axis.FDL_DCPositionAxis fDL_DCPositionAxis2(Td = 1, Ti = 0.9, controllerType = Modelica.Blocks.Types.SimpleController.PI, pidGain = 500, wd = 10, wp = 1)  annotation(
    Placement(visible = true, transformation(origin = {10, 32}, extent = {{-14, -10}, {14, 10}}, rotation = 0)));
  OM_SP7.Axis.FDL_DCPositionAxis fDL_DCPositionAxis3(Td = 1, Ti = 0.9, controllerType = Modelica.Blocks.Types.SimpleController.PI, pidGain = 500, wd = 10, wp = 1)  annotation(
    Placement(visible = true, transformation(origin = {10, 6}, extent = {{-14, -10}, {14, 10}}, rotation = 0)));
  OM_SP7.Axis.FDL_DCPositionAxis fDL_DCPositionAxis4(Td = 1, Ti = 0.9, controllerType = Modelica.Blocks.Types.SimpleController.PI, pidGain = 500, wd = 10, wp = 1)  annotation(
    Placement(visible = true, transformation(origin = {10, -20}, extent = {{-14, -10}, {14, 10}}, rotation = 0)));
  OM_SP7.Axis.FDL_DCPositionAxis fDL_DCPositionAxis5(Td = 1, Ti = 0.9, controllerType = Modelica.Blocks.Types.SimpleController.PI, pidGain = 500, wd = 10, wp = 1)  annotation(
    Placement(visible = true, transformation(origin = {10, -46}, extent = {{-14, -10}, {14, 10}}, rotation = 0)));
  OM_SP7.Axis.FDL_DCPositionAxis fDL_DCPositionAxis6(Td = 1, Ti = 0.9, controllerType = Modelica.Blocks.Types.SimpleController.PI, pidGain = 500, wd = 10, wp = 1)  annotation(
  ...
  OM_SP7.Axis.FDL_DCPositionAxis fDL_DCPositionAxis7(Td = 0.001, Ti = 10, armatureInductance = 0.0074, armatureResistance = 1.4, gearboxRatio = 119, maximumCurrent = 17, nominalCurrent = 4.9, nominalRPM = 3000, nominalVoltage = 48, pidGain = 300, wd = 1, wp = 1) annotation(
...
equation
  connect(gain6.y, fDL_DCPositionAxis6.setPosition) annotation(
    Line(points = {{-31.4, -70}, {-3.4, -70}}, color = {0, 0, 127}));
  connect(gain4.y, fDL_DCPositionAxis4.setPosition) annotation(
    Line(points = {{-31.4, -20}, {-3.4, -20}}, color = {0, 0, 127}));
  connect(gain2.y, fDL_DCPositionAxis2.setPosition) annotation(
    Line(points = {{-31.4, 32}, {-5, 32}}, color = {0, 0, 127}));
  connect(fDL_DCPositionAxis1.flange_b, flange_b[1]) annotation(
    Line(points = {{25, 56}, {40, 56}, {40, 6}, {84, 6}}));
  connect(fDL_DCPositionAxis2.flange_b, flange_b[2]) annotation(
    Line(points = {{25, 32}, {40, 32}, {40, 6}, {84, 6}}));
  connect(fDL_DCPositionAxis3.flange_b, flange_b[3]) annotation(
    Line(points = {{25, 6}, {84, 6}}));
  connect(fDL_DCPositionAxis4.flange_b, flange_b[4]) annotation(
    Line(points = {{25, -20}, {40, -20}, {40, 6}, {84, 6}}));
  connect(fDL_DCPositionAxis5.flange_b, flange_b[5]) annotation(
    Line(points = {{25, -46}, {40, -46}, {40, 6}, {84, 6}}));
  connect(fDL_DCPositionAxis6.flange_b, flange_b[6]) annotation(
  ...
  connect(jointSetPosition[7], fDL_DCPositionAxis7.setPosition) annotation(
    Line(points = {{-84, 6}, {-64, 6}, {-64, 82}, {-5, 82}}, color = {0, 0, 127}));
  connect(fDL_DCPositionAxis7.flange_b, flange_b[7]) annotation(
  ...
  connect(gain5.y, fDL_DCPositionAxis5.setPosition) annotation(
