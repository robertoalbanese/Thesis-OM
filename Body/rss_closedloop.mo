...
model rss_closedloop
  ...
  //parameter Integer theta = 0 "Angle position of the joints w.r.t. the centre of the base";
  ...
  Modelica.Mechanics.MultiBody.Interfaces.Frame_a frame_a annotation(
    Placement(visible = true, transformation(origin = {-80, -20}, extent = {{-16, -16}, {16, 16}}, rotation = 0), iconTransformation(origin = {-102, -2}, extent = {{-16, -16}, {16, 16}}, rotation = 0)));
