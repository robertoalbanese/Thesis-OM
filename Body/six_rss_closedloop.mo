...
model six_rss_closedloop
  ...
  OM_SP7.Body.leg_test leg_test annotation(
    Placement(visible = true, transformation(origin = {-4, 92}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));  equation
  ...
  connect(base.frame_a[1], leg_test.frame_a) annotation(
    Line(points = {{-14, 92}, {-78, 92}, {-78, 20}, {-128, 20}}, color = {95, 95, 95}));
  connect(leg_test.frame_b, fixedTranslation1.frame_b) annotation(
    Line(points = {{60, 80}, {6, 80}, {6, 93}}));
  protected
  annotation(
